              ...
              <div class="card" id="appendload">
                <div class="card-header border-0">
                  <div class="d-flex justify-content-between">
                    ...
                    <a href="#" onclick="printdashsales();">Download as CSV file</a>
                  </div>
                </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-striped" style="width:100%">
                  ...
                  <tbody>
                    ...
                    $query = query("SELECT log_store, loc_systemlog_id, log_type, log_description, log_date_time, zreading FROM posrev.admin_system_logs WHERE guid = '".$_SESSION['client_user_guid']."' ORDER BY log_date_time DESC LIMIT 20");
                    confirm($query);
...
function GetSums() {
  ...
  function printdashsales() {

    var guid = "<?php echo $_SESSION['client_user_guid']; ?>";
    var dateval = $("#datepicker-pick").val();
    $.ajax({
      url: 'actions/printdashboardsales.php',
      type: 'post',
      data: {guid:guid, id:loadid, dateval:dateval},
