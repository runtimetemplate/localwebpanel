      ...
      <div class="row">
        <div class="col-md-3">
          <div class="card card-secondary">
            ...
            <div class="card-body">
              <button class="btn btn-sm btn-secondary btn-block mb-3 " data-toggle="modal" data-target="#modal-formula" type="button">Add New Ingredient</button>
            </div>
          </div>
        </div>
      </div> 
...
function LoadDatatable() {
  $("#example").DataTable({
    ...
    "processing": true,
    "serverSide": true,
    "ajax": "dtserver/getformulas.php"
  });
}
</script>
<?php include_once('modals/addformulamodal.php');?>
</body>
</html>
