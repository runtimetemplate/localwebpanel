...
$FinalRole = "";
if($role == "All") {
    $FinalRole = " position IN('Head Crew','Crew') AND store_id IN (".$_SESSION['manager_store_id'].")";
} elseif ($role == "HeadCrew") {
    $FinalRole = " position = 'Head Crew' AND store_id IN (".$_SESSION['manager_store_id'].")";
} elseif ($role == "Crew") {
    $FinalRole = " position = 'Crew' AND store_id IN (".$_SESSION['manager_store_id'].")";
}
