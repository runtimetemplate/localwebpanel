        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">
              ...
              $sql = "SELECT OT.store_name as StoreName, OT.store_id as StoreID, OT.address as Address, OT.Barangay as Brgy, OT.municipality as Municipality, OT.province as Province, OT.postal_code as Postal FROM posrev.admin_outlets OT WHERE OT.manager_guid = '".$_SESSION['manager_user_guid']."' group by OT.store_name order by OT.store_id;";
              $query = query($sql);
              confirm($query);
          ...
          <div class="card">
                <div class="card-header border-0">
                  <div class="d-flex justify-content-between">
                    ...
                    <a href="#" onclick="printnaysareport();">Generate Naysa Report</a>
                  </div>
                </div>
...
<script>
  ...
  function printnaysareport() {
    var storeid = <?php echo $_GET['viewinv'];?>;
    window.location.href = "actions/generatenaysa.php?storeid="+storeid;
    
    // $.ajax({
    //   url: 'actions/generatenaysa.php',
    //   type: 'post',
    //   data: {storeid:storeid},
    //   // success:function(data){  
    //   //   var win = window.open('actions/' + data, '_blank');
    //   //   win.focus();
    //   //   // deletefile(data);
    //   // }
    // })
